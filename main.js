...
function onSelect(){
    loadGLTF('Duck.gltf').then(result => {
      ...
      result.scene.changeMat = function(){
        if(this.velocity.y <= 0.1){
          this.material.color.set(0x00ff00);
        };
      ...
      result.scene.updateAge = function(t){
